class IRegression:
    ...
    def Compile_Model(self, shape=None, checkpoint_path = None, number_of_epochs_per_print = 0):
        ...
        number_of_epochs_per_print (int): Number of epochs between prints of the PrintProgress callback during training.
        """
